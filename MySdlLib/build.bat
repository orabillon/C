...
gcc -Wall -Werror -pedantic src/main.c src/orn/orn_graphics.c src/orn/orn_font.c src/orn/orn_keyboard.c -g -o bin/prog -I include -L lib -lmingw32 -lSDL2_image -lSDL2_ttf -lSDL2main -lSDL2 
IF %ERRORLEVEL% EQU 0 (
    echo Compilation OK !
    cd .\bin\
    .\prog.exe
